...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/aanandita/.vscode/extensions/wallabyjs.console-ninja-1.0.370/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2014685540588c78f5d4fdBBoPDRsFDlYHCwpUAFtVDVVQVwZV', mode: 'build'}); } catch(cjsError) { try { import('file:///home/aanandita/.vscode/extensions/wallabyjs.console-ninja-1.0.370/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2014685540588c78f5d4fdBBoPDRsFDlYHCwpUAFtVDVVQVwZV', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
